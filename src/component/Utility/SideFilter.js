        ...
        <div className='mt-3'>
            <Row>
                <div className='d-flex flex-column mt-2'>
                    ...
                    <div className='d-flex mt-2'>
                        <input type='checkbox' value='' />
                        <div className='filter-sub me-2'>كهربية</div>
                    </div>
                    <div className='d-flex mt-2'>
                        <input type='checkbox' value='' />
                    ...
                    <div className='d-flex mt-2'>
                        <input type='checkbox' value='' />
                        <div className='filter-sub me-2'>TupperWare</div>
                    </div>
                </div>
                ...
                <div className='d-flex'>
                    ...
                    <input className='m-2 text-center' type='number' style={{ width: '5rem', height: '1.5rem' }} />
                </div>
                <div className='d-flex'>
